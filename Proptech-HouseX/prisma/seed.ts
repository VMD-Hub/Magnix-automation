...
async function main() {
  ...
  const dtaLanding = defaultProjectLanding("DTA Happy Home Nhơn Trạch");
  dtaLanding.heroSubtitle =
    "Khu căn hộ NOXH trong DTA City — 2.192 căn, tiện ích nội khu đầy đủ, giá từ 448 triệu, hỗ trợ vay ngân hàng liên kết";
  dtaLanding.heroImage = { ...DTA_HAPPY_HOME_DEMO_IMAGES.hero };
  dtaLanding.locationMapImage = { ...DTA_HAPPY_HOME_DEMO_IMAGES.locationMap };
  dtaLanding.locationNotes = `DTA Happy Home nằm trong Khu đô thị DTA City, mặt tiền đường Nguyễn Văn Cừ, xã Phước An, huyện Nhơn Trạch — cửa ngõ khu công nghiệp Nhơn Trạch – Đồng Nai, thuận tiện cho công nhân và người lao động an cư gần nơi làm việc.
...
Tiện ích ngoại khu DTA City: chợ truyền thống DTA, Bệnh viện Đa khoa Quốc tế DTA, Trường Mầm non & Tiểu học Quốc tế DTA.`;
  ...
  dtaLanding.faqs = [
    ...
    },
    {
      ...
      a: "Vốn tự có từ 30%, vay tối đa 70% giá trị căn, thời hạn tối đa 20 năm; lãi suất ưu đãi giai đoạn đầu theo ngân hàng liên kết (website CĐT ghi 5,5%/năm 6 tháng đầu).",
    },
    {
  ...
  dtaLanding.gallery = [...DTA_HAPPY_HOME_DEMO_IMAGES.gallery];
  dtaLanding.ctaLabel = "Liên hệ tư vấn";
  dtaLanding.ctaHref = "/lien-he";
  dtaLanding.ctaSubtext =
    "Tư vấn chi tiết hơn về dự án — liên hệ với chúng tôi.";

  const dtaOverview = buildOverviewData(null, {
    totalUnits: 2192,
    blocks: 16,
    landing: dtaLanding,
  });
  ...
  const dtaHappyHome = await prisma.project.upsert({
    ...
    update: {
      ...
      description:
        "DTA Happy Home là dự án nhà ở xã hội do Công ty Cổ phần Đệ Tam triển khai tại Khu đô thị DTA City Nhơn Trạch. Quy mô 2.192 căn, 16 block 5 tầng, giá 448–700 triệu/căn, hỗ trợ vay tới 70%.",
  ...
  await prisma.project.upsert({
    where: { slug: "solena-green-town-binh-tan" },
    update: {
