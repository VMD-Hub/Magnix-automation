...
3. **Tính chính chủ:** Tài khoản trúng thưởng phải trùng khớp thông tin cá nhân (Họ tên, CMND/CCCD/Hộ chiếu, Số điện thoại) với người đứng tên trên Hợp đồng giao dịch bất động sản.
4. **Không chuyển nhượng quà:** Quà không được chuyển nhượng, trừ vợ/chồng, con, cha/mẹ ruột (cần xác minh khi trao quà).

## 4. Cách thức tham gia

1. Đăng nhập tài khoản thành viên trên **HouseX.vn**.
2. Truy cập mục **Khuyến mãi / Vòng Quay May Mắn**.
3. Nhấn **Quay** — hệ thống lựa chọn ngẫu nhiên; kết quả hiển thị ngay và lưu tại mục **Phần quà của bạn**.
...
export const PROMOTION_SPIN_CONSENT_LINE =
  "Bằng việc nhấn Quay, bạn đã đọc và đồng ý với Thể lệ chương trình, bao gồm điều kiện quà tặng chỉ có hiệu lực khi giao dịch trực tiếp qua HouseX.vn.";
