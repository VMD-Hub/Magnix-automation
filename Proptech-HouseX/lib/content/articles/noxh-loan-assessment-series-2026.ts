...
| --- | --- | --- |
| **1. Độ tuổi** | Thời hạn vay; thông lệ 18–75 tuổi tại cuối kỳ vay | [Kiểm tra 60 giây](/cong-cu/kiem-tra-vay-noxh) |
...
**Bước 1 — Kiểm tra độ tuổi:** Xem tuổi hiện tại và tuổi dự kiến tại thời điểm kết thúc khoản vay. Dùng [công cụ 60 giây](/cong-cu/kiem-tra-vay-noxh) — chỉ cần xưng hô và năm sinh.
...
| # | Việc cần làm | Gợi ý |
| --- | --- | --- |
| 1 | Xác định đúng độ tuổi và thời hạn vay dự kiến | [Kiểm tra 60 giây](/cong-cu/kiem-tra-vay-noxh) |
...
Chỉ đủ cho bước ước tính sơ bộ về độ tuổi — dùng [công cụ 60 giây](/cong-cu/kiem-tra-vay-noxh). Để đánh giá đầy đủ, vẫn cần xem thêm thu nhập, nợ hiện tại và hồ sơ tín dụng.
...
## Kiểm tra 60 giây là gì?

Đây là bước **sàng lọc sơ bộ** về độ tuổi vay — không phải phán quyết duyệt vay thay ngân hàng. Bạn nhập xưng hô và năm sinh; hệ thống ước tính:

- Tuổi hiện tại
- Tuổi dự kiến khi kết thúc khoản vay (mặc định kỳ hạn NOXH 20 năm)
- Trạng thái gợi ý: **có thể tiếp tục** / **cần rà soát thêm** / **chưa phù hợp**

→ **[Kiểm tra khả năng vay sơ bộ](${NOXH_LOAN_TOOL_60S})** (miễn phí)

## Vì sao nên làm trước khi nộp hồ sơ?

| Lợi ích | Giải thích |
| --- | --- |
| Tiết kiệm thời gian | Phát hiện sớm vấn đề tuổi — tránh nộp hồ sơ vô ích |
| Giảm rủi ro cọc | Biết hướng đi trước khi cam kết tiền thật |
| Chuẩn bị đúng hướng | Từ kết quả tuổi → sang CIC, thu nhập, hồ sơ |

Ngân hàng xét **tuổi cuối kỳ vay**, không chỉ tuổi hiện tại — chi tiết: [cách tính tuổi vay](/tin-tuc/dieu-kien-vay-noxh-theo-tuoi-hon-nhan).

## 60 giây kiểm tra được gì — và chưa kiểm tra được gì?

**Kiểm tra được (sơ bộ):**
- Tuổi hiện tại và tuổi cuối kỳ vay dự kiến
- Gợi ý có nên tiếp tục chuẩn bị hồ sơ hay không

**Chưa kiểm tra được (cần bước khác):**
- Thu nhập, CIC, nghĩa vụ nợ → [tính hạn mức vay](/cong-cu/tinh-han-muc-vay)
- Lịch sử tín dụng → [tra CIC an toàn](/tin-tuc/cach-tra-cic-an-toan-truoc-khi-vay)
- Điều kiện mua NOXH → [kiểm tra điều kiện](/cong-cu/dieu-kien-noxh)
- Giấy tờ vay → [checklist hồ sơ](/tin-tuc/ho-so-vay-mua-nha-o-xa-hoi)

## Hành trình sau khi kiểm tra 60 giây

1. **Kết quả thuận lợi** → tra CIC, tính hạn mức, đọc [NOXH có vay ngân hàng không](/tin-tuc/mua-nha-o-xa-hoi-co-duoc-vay-ngan-hang-khong).
2. **Cần rà soát** → xem [tuổi vay & hôn nhân](/tin-tuc/dieu-kien-vay-noxh-theo-tuoi-hon-nhan), cân nhắc rút ngắn kỳ hạn hoặc gặp chuyên gia.
3. **Chưa phù hợp** → đừng vội cọc; xem [checklist trước cọc](/tin-tuc/checklist-truoc-khi-dat-coc-noxh) và [pillar thẩm định](/tin-tuc/tham-dinh-khoan-vay-mua-nha-o-xa-hoi).

## Ai nên dùng công cụ này?

- Sắp nộp hồ sơ vay NOXH lần đầu.
- Được môi giới hứa “chắc vay” nhưng chưa tự kiểm tra tuổi.
- Sinh năm sát ngưỡng nghỉ hưu hoặc muốn vay kỳ hạn dài.

## Kết luận

Kiểm tra khả năng vay NOXH trong 60 giây là **cửa vào nhanh nhất** của cụm thẩm định vay — giúp bạn biết tuổi vay có nằm trong vùng an toàn hay không trước khi đầu tư thời gian vào hồ sơ đầy đủ.

Đây là bước **cần**, chưa **đủ**. Sau 60 giây, hãy tiếp tục với CIC, thu nhập và checklist hồ sơ — toàn bộ hành trình tại [tự thẩm định trước khi nộp hồ sơ](/tin-tuc/tham-dinh-khoan-vay-mua-nha-o-xa-hoi).

## Câu hỏi thường gặp

**Kiểm tra 60 giây có thay thế ngân hàng không?**  
Không. Đây chỉ là sàng lọc sơ bộ về tuổi vay. Ngân hàng còn xét thu nhập, CIC, nợ và hồ sơ pháp lý.

**Tôi cần nhập gì?**  
Xưng hô và năm sinh. Số điện thoại/email lấy từ tài khoản nếu bạn đã đăng nhập.

**Kết quả “cần rà soát” nghĩa là gì?**  
Tuổi cuối kỳ vay sát ngưỡng hoặc cần xem lại kỳ hạn — đọc thêm [tuổi vay NOXH](/tin-tuc/dieu-kien-vay-noxh-theo-tuoi-hon-nhan).

**Sau 60 giây tôi nên làm gì tiếp?**  
Tra CIC → tính hạn mức → checklist hồ sơ. Xem [điều kiện vay NOXH](/tin-tuc/mua-nha-o-xa-hoi-co-duoc-vay-ngan-hang-khong).

**Công cụ có miễn phí không?**  
Có — [kiểm tra ngay](${NOXH_LOAN_TOOL_60S}).
...
${closing("kiem-tra-kha-nang-vay-noxh-60-giay")}`,
    ...
    authorName: "HouseX Biên tập",
    seoTitle:
      "Kiểm tra khả năng vay NOXH trong 60 giây — hướng dẫn | HouseX",
    seoDesc:
      "Cách tự kiểm tra khả năng vay mua nhà ở xã hội trong 60 giây: tuổi cuối kỳ vay, bước tiếp theo CIC và hồ sơ — không thay ngân hàng.",
    tags: [TAG, TAG_NOXH, { slug: "goc-chuyen-gia", name: "Góc chuyên gia" }],
    projects: [],
  },
  {
...
| --- | --- | --- |
| Độ tuổi vay | Tuổi cuối kỳ vay có trong ngưỡng? | [Kiểm tra 60 giây](/cong-cu/kiem-tra-vay-noxh) |
...
1. Xác định độ tuổi và thời hạn vay dự kiến — [kiểm tra 60 giây](/cong-cu/kiem-tra-vay-noxh).
...
Kiểm tra CIC trước khi nộp hồ sơ giúp tránh mất thời gian với những vấn đề hoàn toàn có thể phát hiện từ đầu. Đây là bước nên làm trước khi đặt cọc — xem [checklist trước cọc NOXH](/tin-tuc/checklist-truoc-khi-dat-coc-noxh) và [kiểm tra vay 60 giây](/cong-cu/kiem-tra-vay-noxh).
...
[Kiểm tra tuổi vay NOXH trong 60 giây](/cong-cu/kiem-tra-vay-noxh) — chỉ cần xưng hô và năm sinh.
...
1. Tôi sẽ bao nhiêu tuổi khi khoản vay kết thúc? → [Kiểm tra 60 giây](/cong-cu/kiem-tra-vay-noxh)
...
Trước khi nộp, nên hoàn tất: [kiểm tra tuổi vay 60 giây](/cong-cu/kiem-tra-vay-noxh) · [tra CIC](/tin-tuc/cach-tra-cic-an-toan-truoc-khi-vay) · [tính hạn mức](/cong-cu/tinh-han-muc-vay).
...
| --- | --- | --- |
| 1 | Tự kiểm tra khả năng vay | [Kiểm tra 60 giây](/cong-cu/kiem-tra-vay-noxh) |
...
Hãy kiểm tra hồ sơ thật, nhìn vào dữ liệu thật, rồi mới quyết định — bắt đầu từ [tự thẩm định](/tin-tuc/tham-dinh-khoan-vay-mua-nha-o-xa-hoi), [kiểm tra vay 60 giây](/cong-cu/kiem-tra-vay-noxh) và [hạn mức vay](/cong-cu/tinh-han-muc-vay). Đó là cách mua nhà an toàn, tỉnh táo và ít rủi ro nhất.
...
| --- | --- | --- |
| 1 | Độ tuổi & thời hạn vay | [Kiểm tra 60 giây](/cong-cu/kiem-tra-vay-noxh) |
...
| 2 | Tuổi vay phù hợp? | [60 giây](/cong-cu/kiem-tra-vay-noxh) |
...
Độ tuổi, thu nhập, CIC, khoản nợ hiện tại và điều kiện pháp lý hồ sơ mua nhà — dùng [công cụ 60 giây](/cong-cu/kiem-tra-vay-noxh) làm bước đầu.
...
Không có một con số chung cho mọi trường hợp. Tham chiếu trần 25/35/50 triệu (NĐ 136/2026) và nhóm đối tượng Điều 76 — chi tiết trong bài pillar trên.

**Người độc thân và người đã kết hôn có cách tính thu nhập khác nhau không?**  
Có. Hồ sơ xét theo cá nhân hoặc hộ gia đình; trần 25/35/50 triệu khác nhau.
...
Nếu câu trả lời khiến bạn phải đắn đo nhiều, có thể bạn vẫn chưa thật sự đủ an toàn để mua nhà — [kiểm tra vay 60 giây](/cong-cu/kiem-tra-vay-noxh) và [điều kiện NOXH](/cong-cu/dieu-kien-noxh) trước khi cọc.
