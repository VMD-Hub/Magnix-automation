...
Sau khi hiểu vì sao mỗi người có thời hạn vay khác nhau, bạn có thể **ước tính sơ bộ** bằng công cụ miễn phí — chỉ cần xưng hô và năm sinh. Đây là bước **sàng lọc về tuổi vay**, không phải phán quyết duyệt vay thay ngân hàng. Hệ thống ước tính:
...
3. **Chưa phù hợp** → đừng vội cọc; xem [checklist trước cọc](/tin-tuc/checklist-truoc-khi-dat-coc-noxh) và [tự thẩm định trước khi nộp hồ sơ](/tin-tuc/tham-dinh-khoan-vay-mua-nha-o-xa-hoi).
...
Môi giới có thể nói vay 20–30 năm như một con số chung — nhưng **thời hạn vay NOXH thực tế phụ thuộc tuổi của bạn**, không phải lời quảng bá. Kiểm tra tuổi vay trước giúp bạn biết sớm mình nằm trong vùng an toàn hay cần điều chỉnh kỳ hạn, trước khi bỏ thời gian vào hồ sơ đầy đủ hoặc đặt cọc.

Đây là bước **cần**, chưa **đủ**. Sau khi rõ tuổi vay, hãy tiếp tục với CIC, thu nhập và checklist hồ sơ — xem [tự thẩm định trước khi nộp hồ sơ](/tin-tuc/tham-dinh-khoan-vay-mua-nha-o-xa-hoi).

## Câu hỏi thường gặp

**Môi giới nói vay 25 năm — tôi có được không?**  
Chưa chắc. Ngân hàng xét tuổi cuối kỳ vay — nếu vượt ngưỡng, kỳ hạn có thể bị rút ngắn dù thu nhập đủ. Nên tự kiểm tra tuổi vay trước khi tin con số “25 năm” áp dụng cho bạn.
...
${closing("kiem-tra-kha-nang-vay-noxh-60-giay")}`,
    ...
    authorName: "Ban biên tập House X",
    seoTitle:
      "Thời hạn vay NOXH — vì sao không phải ai cũng vay 20–30 năm? | HouseX",
    seoDesc:
