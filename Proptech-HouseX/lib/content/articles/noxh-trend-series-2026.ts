...
Dự án còn lại trong đợt công bố là chung cư **35 Lê Văn Chí** (Phúc Lộc Thọ), giá bình quân **~35,3 triệu/m²** — cao hơn đáng kể so với Lý Thường Kiệt. Chi tiết dự án trên HouseX: [/du-an/chung-cu-phuc-loc-tho-noxh](/du-an/chung-cu-phuc-loc-tho-noxh).
...
CĐT dự kiến hoàn tất, nghiệm thu bàn giao khoảng **tháng 8/2026**. Tra cứu mặt bằng, gallery và FAQ trên trang dự án HouseX: [/du-an/nha-o-xa-hoi-ly-thuong-kiet](/du-an/nha-o-xa-hoi-ly-thuong-kiet).

## Bước tiếp theo trên HouseX

- Đọc tiếp [phân tích so sánh giá NOXH](/tin-tuc/so-sanh-gia-noxh-ly-thuong-kiet-dta-happy-home-2026) — góc nhìn cho người lao động chưa trúng suất nội thành.
- [Tính khoản vay NOXH](/cong-cu/tinh-khoan-vay) với mức giá tham chiếu từng dự án.
- [Đăng ký tư vấn hồ sơ](/lien-he) — HouseX hỗ trợ rà soát điều kiện, không thay vai trò CĐT.
...
*Nguồn tham khảo: VnExpress, Thư viện Pháp luật, Sở Xây dựng TP.HCM. HouseX tổng hợp phục vụ tra cứu — không phải công bố chính thức của cơ quan nhà nước.*`,
  ...
  },
  {
    ...
    excerpt:
      "Phân tích giá/m², tổng giá căn, cạnh tranh hồ sơ và vị trí. Gợi ý lộ trình an cư cho công nhân & người trẻ chưa trúng suất nội thành.",
...
**Ưu điểm:** đất vàng nội thành; tiện ích y tế — giáo dục — thương mại dày; bàn giao sớm (~08/2026).

**Rủi ro thực tế:** tỷ lệ trúng suất thấp khi hồ sơ gấp nhiều chục lần quỹ bán. Giá tổng căn 34,5–77 m² có thể từ **~800 triệu đến ~1,8 tỷ** (chưa phí bảo trì, chưa hệ số vị trí) — không nhẹ với công nhân thu nhập trung bình.

Xem chi tiết dự án: [/du-an/nha-o-xa-hoi-ly-thuong-kiet](/du-an/nha-o-xa-hoi-ly-thuong-kiet).

## DTA Happy Home: lựa chọn “dòng tiền thực tế” cho người lao động
...
- Quỹ căn **Block A10** (30 suất) đang được công bố giá cụ thể — minh bạch từng mã căn trên HouseX (ví dụ [/tin-dang/DTA-HH-A10511](/tin-dang/DTA-HH-A10511) từ ~535 triệu).
- Phù hợp **công nhân KCN Nhơn Trạch – Long Thành**: an cư gần nơi làm việc, giảm chi phí đi lại so với thuê trọ TP.HCM.
- Bàn giao dự kiến **Quý IV/2027** — cần lập kế hoạch tài chính sớm, nhưng **ít áp lực “trúng suất”** hơn Lý Thường Kiệt.
...
## Kết luận góc nhìn HouseX (buyer-first)

- **Ưu tiên sống nội thành, đủ điều kiện & chấp nhận rủi ro trúng suất** → theo dõi sát [Phú Thọ DMC](/du-an/nha-o-xa-hoi-ly-thuong-kiet).
- **Ưu tiên sở hữu NOXH với tổng vốn dưới 700 triệu, gần KCN** → cân nhắc [DTA Happy Home](/du-an/dta-happy-home-nhon-trach) và dùng [công cụ tính vay](/cong-cu/tinh-khoan-vay).
- **Chưa rõ điều kiện NOXH** → [tư vấn hồ sơ miễn phí](/lien-he).

Đọc tiếp: [Lãi suất vay NOXH người dưới 35 tuổi từ 1/7/2026](/tin-tuc/lai-suat-vay-noxh-duoi-35-tuoi-nhnn-2026) — ảnh hưởng trực tiếp tới dòng tiền mua DTA và các dự án NOXH khác.`,
    status: "PUBLISHED",
    ...
    seoDesc:
      "Phân tích 23,25 tr/m² Phú Thọ DMC vs DTA Happy Home 448–700 triệu/căn. Gợi ý an cư cho công nhân & người trẻ NOXH.",
    tags: [
      { slug: "noxh", name: "Nhà ở xã hội" },
...
**Góc nhìn thực tế:** dù mức ưu đãi NHNN có điều chỉnh theo kỳ, **kênh vay NOXH vẫn là lựa chọn tối ưu về chi phí vốn** so với thị trường tự do — miễn là người mua đủ điều kiện đối tượng và dự án đủ điều kiện cho vay.

## DTA Happy Home: lớp ưu đãi từ CĐT + ngân hàng liên kết
...
Khi kết hợp **giá căn từ 448 triệu** (giá CĐT công bố Block A10) với **gói vay 70%**, số tiền vay gốc ban đầu có thể từ **~300 triệu** — mức trả góp hàng tháng dễ mô phỏng trên [công cụ tính khoản vay HouseX](/cong-cu/tinh-khoan-vay).
...
→ [Tính thử trả góp tại đây](/cong-cu/tinh-khoan-vay) | [Tư vấn hồ sơ NOXH](/lien-he)

## Liên hệ với tin nóng Lý Thường Kiệt

Người trẻ đang theo dõi [giá NOXH Lý Thường Kiệt 23,25 tr/m²](/tin-tuc/tp-hcm-cong-bo-gia-2-du-an-noxh-ly-thuong-kiet-phu-tho-dmc) nhưng e ngại áp lực hồ sơ có thể **song song** chuẩn bị tài chính cho phương án **DTA Happy Home** — quỹ căn rõ ràng, phù hợp công nhân vùng Đồng Nai.

Trang dự án: [/du-an/dta-happy-home-nhon-trach](/du-an/dta-happy-home-nhon-trach) · So sánh giá: [/tin-tuc/so-sanh-gia-noxh-ly-thuong-kiet-dta-happy-home-2026](/tin-tuc/so-sanh-gia-noxh-ly-thuong-kiet-dta-happy-home-2026)
