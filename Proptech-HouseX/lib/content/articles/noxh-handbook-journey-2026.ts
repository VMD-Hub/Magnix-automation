...
export const NOXH_HANDBOOK_JOURNEY_CLUSTERS: ReadonlyArray<{
...
}> = [
  {
    ...
    description: "Điều kiện nhà ở, đối tượng Đ.76 trước khi photo hồ sơ.",
  },
  {
    id: "c1-forms",
...
| Nhánh | Bản chất pháp lý | Mẫu dùng | Cơ quan xác nhận | Hệ quả nếu chọn sai |
| --- | --- | --- | --- | --- |
| Chưa có nhà ở | Không có nhà thuộc sở hữu, hoặc GCN không có thông tin nhà ở tại tỉnh dự án | Mẫu 02 | VPĐK đất đai / cơ quan cấp GCN trong 07 ngày | Bị trả hồ sơ vì khai thiếu tài sản nhà ở |
...
NĐ 54 mở rộng nhánh “chưa có nhà” cho trường hợp GCN không thể hiện thông tin nhà ở. Điểm này quan trọng với người có đất nhưng chưa có nhà trên giấy chứng nhận.

## Ba lỗi thực tế khiến Mẫu 02 hoặc 03 mất giá trị

1. Khai theo nơi đang thuê trọ thay vì tỉnh có dự án. Ví dụ làm việc ở TP.HCM nhưng mua dự án tại Đồng Nai thì phải xét tình trạng nhà ở tại Đồng Nai.
2. Chỉ rà tên người đứng đơn mà quên rà vợ/chồng. Hồ sơ NOXH xét cả hộ gia đình liên quan, không phải chỉ một cá nhân.
3. Tự chọn nhánh “nhà xa nơi làm việc” nhưng không có quyết định tỉnh và không có xác nhận đơn vị sử dụng lao động.

## Cách chốt đúng nhánh nhà ở trong 4 bước

1. Xác định đúng tỉnh có dự án NOXH bạn nộp.
2. Liệt kê toàn bộ nhà/đất đứng tên bạn và vợ/chồng tại tỉnh đó.
3. Nếu có nhà, tính diện tích bình quân: tổng diện tích sàn chia cho số người thường trú thực tế tại căn.
4. Đối chiếu với thông báo tiếp nhận dự án để xem tỉnh đó có cơ chế “nhà xa nơi làm việc” hay không.
...
- Sai nhánh ngay từ đầu: CĐT trả hồ sơ, bạn mất lượt nộp đợt đầu.
...
## Tự rà ba trụ cột trước khi photo hồ sơ
...
| Nhà ở | Tại tỉnh dự án, bạn chưa có nhà, có nhà chật, hay có nhà xa nơi làm việc? | Chọn đúng một nhánh và có Mẫu 02 hoặc 03 khớp | Làm lại phần nhà ở trên đơn và xin lại giấy |
...
## Ví dụ chọn nhánh nhà ở (làm mẫu)
...
- Đúng: Tra GCN tại Đồng Nai cho bạn và vợ/chồng. Nếu không có nhà trên GCN tại Đồng Nai → nhánh chưa có nhà → Mẫu 02 tại VPĐK Đồng Nai.

Tình huống: Có căn 40 m² tại tỉnh dự án, 5 người thường trú.

- Tính: 40 ÷ 5 = 8 m²/người < 15 → Mẫu 03 tại UBND xã nơi có căn.

## Checklist 10 điểm trước khi photo hồ sơ nhà ở

- [ ] Đã xác định đúng tỉnh dự án
...
${journeyClosing("dieu-kien-nha-o-noxh-3-tinh-huong-hay-bi-tra-ho-so")}`,
  ...
  },
  {
    ...
    excerpt:
      "Đơn đăng ký NĐ 100 Phụ lục II: tick đối tượng Đ.76, khai vợ/chồng, nhà ở tại tỉnh dự án, cam kết một dự án — năm lỗi hay gặp khi viết tay.",
    body: `${NOXH_FORM_SCOPE_DISCLAIMER}
...
${journeyClosing("mau-01-don-dang-ky-noxh-cach-dien-tranh-loi")}`,
  ...
  },
  {
    ...
    excerpt:
      "Mẫu 04 cho người có HĐLĐ/đơn vị; Mẫu 05 cho k5 không HĐLĐ (CA cấp xã từ NĐ 54). Trần 25/35/50 triệu, lỗi cộng phụ cấp miễn thuế.",
    body: `${NOXH_FORM_SCOPE_DISCLAIMER}
...
Một số tỉnh có hệ số điều chỉnh — tra thông báo Sở Xây dựng tỉnh có dự án trước khi chốt.
...
## Checklist chốt giấy trước khi photo vào hồ sơ

- [ ] Đúng Mẫu 04 hoặc 05 (không nhầm Mẫu 03 — Mẫu 03 là nhà ở)
- [ ] Bình quân 12 tháng ≤ trần 25/35/50 (hoặc trần có hệ số tỉnh)
...
${journeyClosing("mau-04-mau-05-xac-nhan-thu-nhap-noxh-2026")}`,
    ...
    seoDesc:
      "Phân biệt Mẫu 04 (có HĐLĐ) và Mẫu 05 (không HĐLĐ, CA cấp xã). Trần 25/35/50 triệu và lỗi khai thu nhập.",
    tags: [TAG],
    projects: [],
  },
  {
    ...
    excerpt:
      "Mẫu 02 TT-BXD khi chưa có nhà trên GCN tỉnh dự án; Mẫu 03 khi có nhà dưới 15 m²/người. VPĐK đất đai và UBND xã xác nhận trong 07 ngày.",
    body: `${NOXH_FORM_SCOPE_DISCLAIMER}
...
- Mẫu 02 dùng khi bạn chưa có nhà ở hợp lệ tại tỉnh có dự án, hoặc GCN không có thông tin nhà ở.
...
| --- | --- | --- | --- |
| Mẫu 02 | Chưa có nhà ở tại tỉnh dự án | Tình trạng sở hữu và thông tin trên GCN | VPĐK đất đai / cơ quan cấp GCN |
...
1. Chuẩn bị thông tin GCN hoặc kết quả tra cứu nhà đất tại tỉnh dự án.
2. Nộp đơn đề nghị xác nhận tại VPĐK đất đai hoặc cơ quan cấp GCN.
3. Sau khi có Mẫu 02, đối chiếu lại nội dung trên đơn Mẫu 01: phần nhà ở phải cùng một nhánh.
...
## Công thức chọn nhánh nhà ở — làm trước khi xin Mẫu 02 hoặc 03

Bước 1: Xác định tỉnh có dự án NOXH (không phải tỉnh đang thuê trọ).

Bước 2: Tra GCN của bạn và vợ/chồng tại tỉnh đó.

Bước 3: Áp quy tắc:

| Kết quả tra cứu | Nhánh | Mẫu |
| --- | --- | --- |
| Không có GCN nhà ở, hoặc GCN không ghi thông tin nhà ở | Chưa có nhà | Mẫu 02 |
| Có nhà, diện tích sàn ÷ số người cư trú ≥ 15 m² | Không đủ điều kiện nhánh chật | Không nộp theo nhánh chật |
...
Ví dụ: Căn 36 m², 4 người cùng ở → 36 ÷ 4 = 9 m²/người < 15 → đủ nhánh Mẫu 03. Căn 60 m², 3 người → 20 m²/người → không đủ nhánh chật.

## Quy trình xin Mẫu 02 hoặc 03 (từng bước)

Mẫu 02 — chưa có nhà:
1. Chuẩn bị CCCD, thông tin GCN hoặc đơn đề nghị tra cứu tại VPĐK đất đai tỉnh dự án.
...
| Lỗi | Hệ quả | Sửa |
| --- | --- | --- |
| Xin Mẫu 02 tại tỉnh đang ở thay vì tỉnh dự án | Giấy không dùng được | Xin lại đúng tỉnh |
...
${journeyClosing("mau-02-mau-03-dieu-kien-nha-o-noxh")}`,
  ...
  },
  {
    ...
    title: "Nộp hồ sơ NOXH cần photo mấy bộ?",
    excerpt:
      "Số bộ photo không cố định toàn quốc — thường ~3 bộ không vay, ~4 bộ có vay. Bắt buộc đọc thông báo tiếp nhận của đúng chủ đầu tư.",
    body: `${NOXH_FORM_SCOPE_DISCLAIMER}

## Nộp hồ sơ NOXH cần photo mấy bộ?

Không có một con số áp cho toàn quốc. Thực tế tiếp nhận thường là:

| Tình huống | Số bộ hay gặp | Vì sao |
| --- | --- | --- |
| Mua hoặc thuê mua, không vay | 2 đến 3 bộ | CĐT lưu, bộ phận xét duyệt lưu, có thể thêm bộ dự phòng |
| Mua hoặc thuê mua có vay | 3 đến 4 bộ | Thêm bộ cho ngân hàng hoặc đơn vị phối hợp |
| Nộp online | 1 bộ scan | Theo cổng tiếp nhận của dự án |

Con số cuối cùng phải lấy từ thông báo tiếp nhận hồ sơ của chính dự án đó. Nghị định chỉ quy định loại giấy, không quy định số bộ photo.

## Bản chất của “một bộ hồ sơ”

Một bộ không phải một vài tờ đại diện. Một bộ là toàn bộ danh mục giấy được photo hoặc in đầy đủ theo cùng một cấu trúc để một đầu mối có thể xét độc lập. Thiếu một giấy trong một bộ là coi như bộ đó chưa hoàn chỉnh.

## Danh mục tối thiểu của mỗi bộ

- Đơn Mẫu 01 NĐ 100 đã ký
- CCCD của người đứng đơn và vợ/chồng nếu đã kết hôn
- Giấy xác nhận thu nhập đúng mẫu
- Giấy xác nhận nhà ở đúng nhánh Mẫu 02 hoặc Mẫu 03 nếu thuộc diện phải nộp
- Giấy tờ cư trú, hồ sơ vay, giấy tờ đối tượng đặc thù nếu dự án yêu cầu

## Lỗi photo hồ sơ rất hay gặp

1. Mỗi bộ một kiểu, bộ có Mẫu 04 nhưng bộ khác lại thiếu.
2. Bộ photo xong nhưng quên bản gốc để đối chiếu khi nộp trực tiếp.
3. Photo trước rồi mới ký, dẫn đến có bộ có chữ ký, có bộ không.
4. Bản scan nộp online thiếu mặt sau CCCD hoặc thiếu trang cuối của đơn.

## Cách chuẩn bị để không bị quay về photo lại

1. Gọi hoặc nhắn bộ phận tiếp nhận để chốt số bộ.
2. Chốt trước là có vay hay không vay, vì số bộ thường thay đổi theo hồ sơ vay.
3. Sắp giấy theo cùng một thứ tự cho mọi bộ.
4. Ký xong toàn bộ giấy cần ký rồi mới photo nhân bản.
5. Đánh dấu kiểm từng bộ trước khi ghim hoặc bỏ bìa.

## Danh mục một bộ — đánh số thứ tự khi photo

Sắp xếp mỗi bộ theo cùng thứ tự này (chỉnh theo thông báo CĐT nếu khác):

1. Đơn Mẫu 01 NĐ 100 (đủ trang, đã ký)
2. CCCD người đứng đơn (mặt trước + sau)
3. CCCD vợ/chồng nếu đã kết hôn
4. Giấy xác nhận thu nhập (Mẫu 04, 05, hoặc BQP/BCA)
5. Giấy xác nhận nhà ở (Mẫu 02 hoặc 03 nếu có)
6. CT07 hoặc xác nhận cư trú (nếu CĐT yêu cầu)
7. Hồ sơ vay ngân hàng (nếu có vay — thường là bộ thêm)

Ghi ngoài bìa mỗi bộ: Họ tên · SĐT · Dự án · Bộ 1/3 (hoặc 1/4).

## Mẫu tin nhắn hỏi CĐT trước khi photo

“Em chuẩn bị nộp hồ sơ dự án [tên]. Nhờ anh/chị xác nhận: (1) cần mấy bộ photo bản giấy; (2) có vay NHCSXH/ngân hàng liên kết thì thêm mấy bộ; (3) bản sao có cần chứng thực không; (4) nộp online hay trực tiếp; (5) thiếu một giấy có được bổ sung sau không.”

Lưu screenshot trả lời — tránh tranh chấp “bên em không nói vậy”.

## Bảng quyết định số bộ

| Câu trả lời CĐT | Số bộ chuẩn bị |
| --- | --- |
| Không vay, nộp trực tiếp | 2–3 bộ giấy |
| Có vay qua NH liên kết | 3–4 bộ (thêm bộ cho NH) |
| Chỉ nộp online | 1 bộ PDF scan đủ danh mục |
| CĐT không trả lời rõ | Chuẩn bị 3 bộ + 1 bộ scan dự phòng |

## Lỗi photo và cách tránh

| Lỗi | Hệ quả | Tránh bằng |
| --- | --- | --- |
| Ký sau khi photo | Bộ 1 có chữ ký, bộ 2 không | Ký hết giấy trước, photo sau |
| Thiếu mặt sau CCCD | Bị trả bổ sung, mất lượt | Checklist 7 mục danh mục trên |
| Mỗi bộ thiếu giấy khác nhau | CĐT không nhận cả đợt | Photo xong bộ 1, dùng bộ 1 làm master copy bộ 2, 3 |
...
${journeyClosing("bao-nhieu-bo-ho-so-photo-noxh")}`,
    ...
    coverImageUrl: null,
    authorName: "Ban biên tập House X",
    seoTitle: "Nộp hồ sơ NOXH photo mấy bộ? 3 hay 4? | HouseX",
    seoDesc:
      "Số bộ hồ sơ photo NOXH tùy chủ đầu tư. Checklist danh mục giấy mỗi bộ và câu hỏi cần hỏi CĐT.",
    tags: [TAG],
    projects: [],
  },
  {
...
| 3 | Giấy xác nhận nhà ở Mẫu 02/03 (nếu áp dụng) | Theo tỉnh dự án |
...
- [ ] Nhà ở khớp Mẫu 02/03 tại tỉnh dự án
...
| Mẫu 02 (chưa có nhà) | Tra cứu GCN tại tỉnh dự án (bạn + vợ/chồng) | Không có nhà hoặc GCN không ghi thông tin nhà ở | Không khai “chưa có nhà” nếu sổ có nhà |
...
3. Với nhà ở: tra GCN tỉnh dự án cho cả hai vợ chồng — ghi rõ có/không có nhà.
...
- [ ] GCN tỉnh dự án đã tra cho cả vợ chồng
...
- [ ] Đã hỏi CĐT số bộ photo và danh mục chính xác
...
| Không đủ điều kiện thật | Vượt trần thu nhập, có nhà tại tỉnh dự án, sai đối tượng Đ.76 | Không photo lại cùng dữ liệu — phải thay đổi tình trạng thật hoặc dừng | Không, cho đến khi đủ điều kiện |
...
1. Tra GCN tỉnh dự án cả vợ chồng.
2. Nếu có nhà → không khai “chưa có nhà”; chuyển nhánh Mẫu 03 nếu đủ diện tích thấp.
