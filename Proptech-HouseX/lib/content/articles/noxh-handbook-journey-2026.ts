...
export const NOXH_HANDBOOK_JOURNEY_ARTICLES_2026: ArticleDetail[] = [
  {
    ...
    body: `## Vì sao bị trả hồ sơ dù đã thỏa điều kiện về thu nhập?
...
| Thu nhập | Bình quân 12 tháng có trong trần không? | Tổng thu nhập thực nhận 12 tháng chia 12 không vượt: độc thân 25 triệu; nuôi con dưới 18 tuổi 35 triệu; vợ chồng 50 triệu | Không nộp nếu vượt trần; hoặc chờ thay đổi thu nhập thật |
...
## Danh mục kiểm 10 điểm trước khi chuẩn bị hồ sơ nhà ở
...
| Quân nhân, CA tại ngũ | k7 | 11.2 | Mẫu BQP/BCA — không dùng trần dân sự độc thân 25 / nuôi con dưới 18 tuổi 35 / vợ chồng 50 triệu |
...
## Danh mục kiểm chốt đơn trước khi chuẩn bị bộ hồ sơ
...
| Mỗi bộ thiếu giấy khác nhau | Cả đợt bị trả | So danh mục trên từng bộ |
...
| Căn cứ thu nhập | Điều 67, ngưỡng tham chiếu Đại tá | Trần NĐ 136: độc thân 25 triệu; nuôi con dưới 18 tuổi 35 triệu; vợ chồng 50 triệu |
...
3. Điền Mẫu 01: tick k7, mục 11.2 — không ghi nhánh trần dân sự (độc thân 25 triệu / nuôi con dưới 18 tuổi 35 triệu / vợ chồng 50 triệu).
4. Đối chiếu thu nhập theo Điều 67 NĐ 100 (tham chiếu mức Đại tá) — do đơn vị xác nhận, không tự quy đổi.
5. Chuẩn bị bộ hồ sơ theo số bộ CĐT yêu cầu.
...
| Trần thu nhập | Điều 67 (tham chiếu mức Đại tá) | Độc thân 25 / nuôi con dưới 18 tuổi 35 / vợ chồng 50 triệu |
...
| Ghi 11.1 + trần dân sự (vd độc thân 25 triệu) cho k7 | Sai căn cứ xét | Làm lại đơn, mục 11.2 |
| Nhầm Mẫu 06 TT 05 (vay tự xây) | Sai loại hồ sơ hoàn toàn | Bỏ Mẫu 06 — không dùng cho mua căn dự án |

## Danh mục kiểm k7 trước khi nộp
...
${journeyClosing("llvt-k7-ho-so-noxh-mau-bqp-bca")}`,
    ...
    seoDesc:
      "k7: mục 11.2, thu nhập Điều 67 (mức Đại tá), giấy BQP/BCA. Không dùng trần dân sự NĐ 136 (độc thân 25 triệu, nuôi con dưới 18 tuổi 35 triệu, vợ chồng 50 triệu). Không nhầm Mẫu 06.",
    tags: [TAG],
    projects: [],
  },
  {
    ...
    body: `## Giấy xác nhận NOXH có hiệu lực bao lâu?
...
${journeyClosing("thoi-han-12-thang-giay-xac-nhan-noxh")}`,
  ...
  },
  {
    ...
    excerpt:
      "NOXH nghiêng về hậu kiểm thay vì tiền kiểm sâu: khi nộp, người đăng ký kê khai và cam kết trung thực; cơ quan không soi hết dữ liệu gốc ngay từ đầu. Sau đó có thể đối chiếu giấy xác nhận với BHXH, Thuế và CSDL cư trú/đất đai khi công khai danh sách, thanh tra hoặc hậu kiểm chuyên đề.",
    body: `## Từ tiền kiểm sang hậu kiểm nghĩa là gì?

Hướng thủ tục hiện hành (NĐ 54 và thực tế tiếp nhận) không đặt trọng tâm vào việc cơ quan quét sâu toàn bộ hồ sơ trước khi nhận như tiền kiểm. Người đăng ký kê khai, cam kết trung thực; trách nhiệm khớp giấy với dữ liệu gốc (BHXH, Thuế, cư trú, đất đai) đặt nặng hơn lên người nộp.

Hậu kiểm là bước đối chiếu lại sau khi hồ sơ đã vào quy trình: công khai danh sách, thanh tra chuyên đề, hoặc khi có dấu hiệu bất thường. Giấy xác nhận DN ký có thể bị so với BHXH và Thuế — không phải lúc nào cũng xảy ra ngay ngày nộp, nhưng xảy ra thì hệ quả nặng nếu lệch.

## Hậu kiểm NOXH kiểm gì và khi nào?

Các mốc thời gian tham chiếu:
1. Nộp hồ sơ → CĐT rà danh mục và hình thức (không thay cho đối chiếu BHXH/Thuế sâu).
...
Kết luận thanh tra 09/KL-TT (19/6/2026) cho thấy giấy xác nhận thu nhập có thể bị đối chiếu ngược với BHXH. Chi tiết phát hiện và danh mục kiểm trước khi cọc: [Bài học từ kết luận thanh tra tại Đồng Nai 06/2026](${articlePath("bai-hoc-thanh-tra-noxh-dong-nai-2026")}).

## Nếu phát hiện lệch — xử lý theo mức độ

| Mức độ | Dấu hiệu | Việc làm ngay |
| --- | --- | --- |
| Nhẹ | Sai địa chỉ, thiếu trang bản sao, giấy sắp hết 12 tháng | Sửa và chuẩn bị lại trước ngày nộp |
| Trung bình | Lương trên giấy khác bảng lương/BHXH | Xin lại Mẫu 04 tại đơn vị đúng |
| Nặng | Khai chưa có nhà nhưng GCN có nhà; nhờ DN ký khi không làm việc tại đó | Dừng nộp bộ giấy hiện tại. Sửa đúng tình trạng thật (khai lại nhà ở / xin giấy tại DN đang đóng BHXH), rồi mới nộp. Giữ nguyên bộ lệch mà vẫn nộp → dễ bị loại hoặc bị phát hiện khi hậu kiểm |
...
${journeyClosing("hau-kiem-noxh-doi-chieu-bhxh-thue-2026")}`,
    ...
    seoDesc:
      "NOXH nghiêng hậu kiểm thay tiền kiểm sâu: kê khai–cam kết khi nộp; đối chiếu BHXH, Thuế, cư trú/đất đai khi công khai danh sách hoặc thanh tra.",
    tags: [TAG],
    projects: [],
  },
  {
...
${journeyClosing("bai-hoc-thanh-tra-noxh-dong-nai-2026")}`,
  ...
  },
  {
    ...
    body: `## Mua NOXH cần chuẩn bị bao nhiêu vốn tự có?
...
${journeyClosing("room-tin-dung-noxh-va-30-von-tu-co")}`,
  ...
  },
  {
    ...
    excerpt:
      "Pháp luật không quy định một thủ tục giải trình NOXH thống nhất khi hồ sơ bị trả hoặc không đủ điều kiện. Tùy tình huống: yêu cầu chủ đầu tư thông báo lý do bằng văn bản; bổ sung hồ sơ nếu còn được tiếp nhận; sửa dữ liệu tại cơ quan nguồn (thuế, BHXH, cư trú, đất đai); khiếu nại theo Luật Khiếu nại 2011 nếu đã có quyết định hành chính bất lợi.",
    body: `## Bị loại hồ sơ NOXH — làm gì trong 48 giờ đầu?

Bước 1: Xin lý do bằng văn bản hoặc email có đầu mối chủ đầu tư — không chỉ nghe miệng.
...
| --- | --- | --- | --- |
| Lỗi kỹ thuật | Thiếu trang đơn, sai mẫu, giấy hết 12 tháng, bản sao không đạt | Bổ sung đúng giấy theo hướng dẫn CĐT | Có, nếu còn đợt tiếp nhận |
| Không đủ điều kiện thật | Vượt trần thu nhập, có nhà tại tỉnh/thành phố nơi có dự án, sai đối tượng Đ.76 | Không nộp lại cùng dữ liệu lệch — phải thay đổi tình trạng thật hoặc dừng | Không, cho đến khi đủ điều kiện |
...
Nếu chỉ nghe “bị loại” mà không có văn bản, yêu cầu lại — đây là căn cứ để biết sửa đúng chỗ.

## Sửa dữ liệu tại cơ quan nguồn trước khi làm giấy mới
...
Không có cổng hành chính riêng để “giải trình lệch thuế/BHXH trong hồ sơ NOXH”. Khi dữ liệu nguồn sai, phải sửa tại cơ quan quản lý dữ liệu đó (Thuế, BHXH, Công an, VPĐK…) rồi mới xin lại giấy xác nhận.

## Khi nào bổ sung hồ sơ, khi nào khiếu nại?

Bổ sung giấy khi: thiếu giấy, sai biểu mẫu, hết hạn 12 tháng, bản sao không đạt — và CĐT xác nhận còn nhận bổ sung.

Khiếu nại (Luật Khiếu nại 2011; thời hiệu thường 90 ngày kể từ ngày nhận được hoặc biết được quyết định hành chính) khi: đã có quyết định hành chính bất lợi ảnh hưởng trực tiếp quyền, lợi ích hợp pháp — không áp dụng khi chỉ bị trả hồ sơ / thông báo chưa đủ điều kiện mà không kèm quyết định hành chính.

Tố cáo (Luật Tố cáo 2018) khi: có căn cứ nghi cán bộ hoặc chủ đầu tư vi phạm pháp luật trong xét duyệt — cần tài liệu cụ thể, không chỉ bất mãn kết quả.

## Bốn kịch bản thường gặp — xử lý từng bước

Kịch bản A — “Thu nhập vượt trần”:
1. Tự tính lại 12 tháng: tổng ÷ 12 so với trần đúng nhóm (độc thân 25 triệu; nuôi con dưới 18 tuổi 35 triệu; vợ chồng 50 triệu).
...
3. Nếu quá 15 ngày không trả lời sau công khai danh sách → ghi nhận để khiếu nại nếu sau đó có quyết định hành chính.

## Hệ quả nếu xử lý sai hướng

- Bổ sung sai giấy (vẫn lệch BHXH): bị loại lại ở hậu kiểm.
- Khiếu nại khi chỉ thiếu một tờ bản sao: mất thời gian, trễ đợt tiếp nhận.
...
${journeyClosing("bi-loai-ho-so-noxh-lam-gi-tiep-theo")}`,
    ...
    seoDesc:
      "Hồ sơ NOXH bị trả hoặc không đủ điều kiện: yêu cầu lý do bằng văn bản, bổ sung hồ sơ, sửa dữ liệu tại cơ quan nguồn, khiếu nại khi có quyết định hành chính.",
    tags: [TAG],
    projects: [],
  },
];
