...
const TITLE_HOOKS: readonly string[] = [
  ...
  "TOD Nhơn Trạch — sống gần ga metro quy hoạch: {code} NOXH {price}",
  ...
  "Sống trong vùng TOD tương lai — {code} NOXH Nhơn Trạch, {area}m² · {price}",
...
export const LISTING_TITLE_FRAMEWORK = {
  ...
  hooks: [
    ...
    "Đô thị tương lai & TOD / metro ngầm quy hoạch / đô thị vệ tinh Long Thành",
  ...
  todGuidelines: [
    "Dùng từ khóa hiện đại: TOD, metro ngầm, đô thị vệ tinh, hạ tầng liên vùng, ga quy hoạch S12/S13",
    "Luôn gắn nhãn (quy hoạch) hoặc ngôn ngữ tương lai — không cam kết đã vận hành hay cách ga X phút",
    "Kết hợp cảm xúc + SEO: ví dụ «Đón đầu TOD — an cư NOXH …» thay vì chỉ «Gần metro»",
  ],
  ...
  avoid: [
    ...
    "Cam kết «cách metro 5 phút» / «tăng giá chắc chắn» khi tuyến chưa vận hành",
