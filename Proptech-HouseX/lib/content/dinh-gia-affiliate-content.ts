...
export const DING_GIA_HUB_INTRO =
  "Thẩm định giá bất động sản là hoạt động xác định giá trị tài sản tại một thời điểm, phục vụ mục đích cụ thể — theo Chuẩn mực thẩm định giá Việt Nam. HouseX đồng hành quy trình 6 bước: từ tra cứu & khởi tạo hồ sơ, khảo sát hiện trạng đến bàn giao chứng thư. Phù hợp chủ nhà, hồ sơ ngân hàng, thừa kế và chứng minh tài sản visa.";
