...
export const DING_GIA_HUB_FAQS: AffiliateFaq[] = [
  ...
  },
  {
    ...
    a: "Tra cứu/ước lượng giá thị trường mang tính tham khảo nhanh. Thẩm định chính thức yêu cầu khảo sát hiện trạng, thu thập dữ liệu thị trường, áp dụng phương pháp chuẩn (so sánh, chi phí, thu nhập…) và phát hành chứng thư — dùng được cho ngân hàng, cơ quan nhà nước, tòa án.",
  },
  {
    q: "Thẩm định giá mất bao lâu?",
    a: "Thường 3–10 ngày làm việc tùy loại tài sản, độ phức tạp hồ sơ và mục đích. Căn hộ chung cư đủ pháp lý thường nhanh hơn quyền sử dụng đất phức tạp hoặc nhà xưởng.",
  },
  {
    q: "Chi phí thẩm định giá phụ thuộc vào đâu?",
    a: "Loại tài sản, diện tích, vị trí, mục đích thẩm định và độ phức tạp pháp lý. HouseX báo phí cụ thể sau khi xem brief — trước khi bạn xác nhận triển khai dịch vụ.",
  },
];
...
1. Gửi yêu cầu qua form — mô tả loại tài sản, địa chỉ, mục đích tra cứu
2. Tư vấn viên HouseX làm rõ nhu cầu (báo cáo tham khảo hay chứng thư chính thức)
3. Tiếp nhận hồ sơ và lên lịch khảo sát hiện trạng
4. Thẩm định viên thu thập dữ liệu so sánh thị trường, lập báo cáo
5. Bàn giao báo cáo/chứng thư — HouseX hỗ trợ theo dõi tiến độ và giải đáp thắc mắc
...
Giá trị thẩm định phục vụ mục đích xét duyệt tín dụng có thể khác giá thỏa thuận mua bán. Ngân hàng thường lấy giá thấp hơn giữa giá giao dịch và giá thẩm định làm cơ sở cho vay.`,
    faqs: [
      ...
      },
      {
        ...
        a: "Có. HouseX có dịch vụ tư vấn vay tại /tai-chinh. Thẩm định giá và hồ sơ vay được đồng bộ khi bạn cần — một đầu mối, tiết kiệm thời gian.",
      },
      {
...
HouseX triển khai thẩm định giá bất động sản theo chuẩn ngành — từ tiếp nhận hồ sơ, khảo sát hiện trạng đến phát hành chứng thư. Mọi chứng thư do thẩm định viên được cấp phép ký và đóng dấu hợp lệ.`,
    faqs: [
      {
...
export const DING_GIA_HUB_INTRO =
  "Thẩm định giá bất động sản là hoạt động xác định giá trị tài sản tại một thời điểm, phục vụ mục đích cụ thể — theo Chuẩn mực thẩm định giá Việt Nam. HouseX cung cấp dịch vụ thẩm định chuyên nghiệp cho từng nhu cầu: tra cứu giá chủ nhà, thẩm định ngân hàng, phân chia thừa kế, chứng minh tài sản visa.";

export const DING_GIA_PARTNER_INTRO =
  "HouseX triển khai thẩm định giá bất động sản theo chuẩn ngành — minh bạch quy trình, đúng quy định pháp luật Việt Nam.";
