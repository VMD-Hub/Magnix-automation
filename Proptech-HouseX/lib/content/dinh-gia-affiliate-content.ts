...
export const DING_GIA_SERVICES: AffiliateService[] = [
  {
    ...
    metaDescription:
      "Chủ nhà cần biết giá BĐS trước khi bán hoặc cho thuê — House X thẩm định chuyên nghiệp, báo cáo theo chuẩn thị trường Việt Nam.",
...
> **Lưu ý:** Giá trị ước tính công trình (nếu có) thường tính trên đơn giá nhà thô — không bao gồm chi phí hoàn thiện và nội thất trừ khi thỏa thuận riêng.`,
  ...
  },
  {
    ...
    metaDescription:
      "Thẩm định giá BĐS làm cơ sở ngân hàng phê duyệt và giải ngân vay mua nhà, thế chấp — House X đồng hành chuẩn bị hồ sơ vay.",
...
Giá trị thẩm định phục vụ mục đích xét duyệt tín dụng có thể khác giá thỏa thuận mua bán. Ngân hàng thường lấy giá thấp hơn giữa giá giao dịch và giá thẩm định làm cơ sở cho vay.`,
  ...
  },
  {
    ...
    metaDescription:
      "Chứng thư định giá BĐS hợp pháp theo Chuẩn mực thẩm định giá Việt Nam — đơn vị được cấp phép, House X đồng hành quy trình.",
...
Mọi chứng thư do thẩm định viên được cấp phép ký và đóng dấu hợp lệ.`,
  ...
  },
  {
    ...
    metaDescription:
      "Thẩm định BĐS phục vụ phân chia di sản thừa kế công bằng — House X lập chứng thư theo chuẩn pháp lý và hỗ trợ giải thích kết quả.",
...
Kết quả thẩm định gắn với mục đích và thời điểm cụ thể. Các bên nên thống nhất sử dụng một chứng thư do cùng đơn vị lập để tránh chênh lệch.`,
  ...
  },
  {
    ...
    metaDescription:
      "Thẩm định BĐS phục vụ hồ sơ visa, định cư — chứng thư định giá và hướng dẫn hợp pháp hóa lãnh sự trên House X.",
