...
3. Thu nhập — với công nhân KCN, CBCCVC, người thu nhập thấp…: không vượt mức trần tại Điều 30 [Nghị định 100/2024/NĐ-CP](https://vanban.chinhphu.vn/?docid=210760&pageid=27160), hiện được điều chỉnh bởi [Nghị định 136/2026/NĐ-CP](https://vanban.chinhphu.vn/?classid=1&docid=217605&pageid=27160).
...
Cán bộ, công chức, viên chức (khoản 4) — áp dụng mức trần thu nhập Điều 30; thu nhập xác nhận qua cơ quan, đơn vị công tác.

Người thu nhập thấp tại đô thị (khoản 3) — thường cạnh tranh cao tại NOXH nội thành như [Lý Thường Kiệt](/du-an/nha-o-xa-hoi-ly-thuong-kiet) (>12.000 hồ sơ / 755 suất).
...
Các nhóm khác (người có công, quân nhân, hộ bị thu hồi đất, tái định cư…) có quy trình xác nhận riêng. Quân nhân, công an thuộc khoản 7 Điều 76 áp dụng Điều 67 NĐ 100/2024 (mức tham chiếu lương Đại tá, không phải bảng 25/35/50 triệu).
...
Hồ sơ hợp lệ phải qua cửa điều kiện cần: đúng đối tượng (Đ.76), đúng tình trạng nhà ở (Đ.77), đúng trần thu nhập (Đ.30). Thiếu một trong ba, hồ sơ bị loại ngay tại bước rà soát.
