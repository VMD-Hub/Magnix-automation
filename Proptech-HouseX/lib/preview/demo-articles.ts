...
import { NOXH_LOAN_CHANNEL_COMPARE_ARTICLES_2026 } from "@/lib/content/articles/noxh-loan-channel-compare-2026";
...
- Ước lượng trả góp: [công cụ tính khoản vay](/tinh-tra-gop) · [lãi suất dưới 35 tuổi](/tin-tuc/lai-suat-vay-noxh-duoi-35-tuoi-nhnn-2026).
...
Bát trạch là tham khảo văn hóa — không thay thế pháp lý, ánh sáng, thông gió hay khả năng tài chính. Kết hợp với [chuyên mục phong thủy](/phong-thuy) và [thẩm định vay](/tinh-tra-gop) trước khi quyết định.`,
    status: "PUBLISHED",
...
Xem thêm [chuyên mục phong thủy](/phong-thuy) và [xem hướng nhà](/cong-cu/xem-huong-nha).`,
  ...
  ...NOXH_LOAN_CHANNEL_COMPARE_ARTICLES_2026,
