...
| 1b | Kiến thức BĐS | Ô `/tin-tuc` · Path: `/tin-tuc/kien-thuc` | **Kiến thức bất động sản** | Kiến thức bất động sản — hành lang, thuê dài hạn & hạ tầng | Kiến thức BĐS — hành lang, BTR, hạ tầng \| House X | `/tin-tuc/kien-thuc` | URL wiki cũ của BTR/corridor → 301 sang silo này | House X có hub kiến thức BĐS (không phải hồ sơ NOXH) không? |
