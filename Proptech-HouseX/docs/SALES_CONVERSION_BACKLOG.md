...
- `runtime_evidence: PRODUCTION-PROVEN` — sales-ops E2E
  `smoke-ops-1784394663714` (2026-07-18); see `SALES_CONVERSION_G1_G2_EVIDENCE.md`.
  UID ingest + SC-6 consent gate also PRODUCTION-PROVEN separately.
...
- `runtime_evidence: PRODUCTION-PROVEN` — sales-ops E2E
  `smoke-ops-1784394663714` (2026-07-18).
...
- `runtime_evidence: PRODUCTION-PROVEN` (profile upsert in sales-ops E2E
  `smoke-ops-1784394663714`); BuyerMatch recommendation APIs remain on prod —
  Ops daily matching UI still cohort-driven.
...
- `runtime_evidence: PRODUCTION-PROVEN` — sales-ops E2E
  `smoke-ops-1784394663714` (appointment SCHEDULED→COMPLETED).
- Target gate: G1 authoritative foundation.
