...
| `housex-noxh-lead-route` | `housex-noxh-lead-route.workflow.json` | Webhook POST ×2 + Manual | L0 | — | ✅ | **HouseX Events Hub:** NOXH + form + nurture + **attribution.conflict** + đăng ký → Sheet + Telegram | staging |
