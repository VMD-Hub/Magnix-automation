/**
 * Parse Pain Intake LLM JSON → intake_v1 (Layer A)
 * Mirror: n8n-workflows/code/social-listening/03-parse-pain-intake.js
 */
...
export function parsePainIntake(raw) {
  ...
  return { ok: true, intake_v1, verdict, score };
}
