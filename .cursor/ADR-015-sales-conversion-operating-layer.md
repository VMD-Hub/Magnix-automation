...
**SC-6:** `NurtureEnrollment` + eligibility/enroll/dispatch APIs; `lead.nurture` v1
vẫn enqueue nhưng fail-closed nếu thiếu marketing consent hoặc enrollment CANCELLED.
Admin board: `/admin/conversion` (Enroll / Stop / next touch). Runtime evidence
production: **PASS** 2026-07-18 (`smoke-sc6-1784348544598`, dry-run) — xem
`Proptech-HouseX/docs/SALES_CONVERSION_G1_G2_EVIDENCE.md`.
