...
>
> **Rental Platform (ADR-018):** Lớp 1 nền tảng QC tin thuê (Journey A / `ADVERTISING`) + Lớp 2 tìm khách/bán phòng **hoa hồng** (Minh An + đối tác) + Lớp 3 QL vận hành **sau theo P&L** — **cấm thuê lại**. Không build PMS. Research: `Proptech-HouseX/docs/research/RENTAL_PM_RESEARCH_EVAL_2026-07.md`. Impl: `Proptech-HouseX/docs/strategy/RENTAL_IMPL_PLAN_2026-07.md` (Wave 0–2). KPI: `/admin/rental-kpi`. Chi tiết: `.cursor/ADR-018-rental-advertising-partner-lane.md`.
